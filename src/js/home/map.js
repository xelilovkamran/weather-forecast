...
function loadMap() {
    ...
    div.innerHTML = `
      <svg
        ...
        viewbox="0 0 965 983"
      >
        <a href="./src/pages/weather.html" target="_self">
          <path
...
async function writeRegionName(svg) {
    ...
    svg.addEventListener("mousemove", (e) => {
        if (e.target.getAttribute("name") === null) {
            ...
            information.innerHTML = `${e.target.getAttribute("name")}`;
            information.style.top = `${e.layerY - 50}px`;
            information.style.left = `${e.layerX + 20}px`;
...
export { loadMap, writeRegionName };
