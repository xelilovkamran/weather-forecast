...
const regionSelection = document.querySelector("#regionNames");
...
regionSelection.addEventListener("change", async (e) => {
    if (regionSelection.value !== regionName.toLocaleLowerCase()) {
        regionName = regionSelection.value;
